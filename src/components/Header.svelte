...
+ (y>0 ? " py-4 bg-slate-950 border-violet-950":" py-6 bg-transparent border-transparent")
    ...
    <h1 class="font-medium">
        <b class="font-bold poppins">Vrushabh J V</b>
    </h1>
    ...
    <a href="https://www.linkedin.com/in/vrushabh-j-v-91155a229" 
    target="_blank"
    class="blueShadow relative overflow-hidden px-5 py-2 group
    rounded-full bg-white text-slate-950">
        <div class="absolute top-0 right-full w-full h-full bg-violet-400 opacity-40
        group-hover:translate-x-full z-0 duration-200">

        </div>
        <h4 class="relative z-9 font-semibold">Get in touch</h4>
